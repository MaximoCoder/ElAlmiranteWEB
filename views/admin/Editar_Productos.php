                                    ...
                                    <tr data-id="<?= $platillo['IdPlatillo']; ?>">
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editarPlatilloModal"
                                               onclick="abrirModalEditar(<?= $platillo['IdPlatillo']; ?>, '<?= htmlspecialchars($platillo['NombrePlatillo']); ?>', '<?= htmlspecialchars($platillo['DescripciónPlatillo']); ?>', '<?= htmlspecialchars($platillo['PrecioPlatillo']); ?>', '<?= htmlspecialchars($platillo['Disponibilidad']); ?>')">Editar</a>
...
<script>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#descripcionPlatilloEditar').val(data.DescripciónPlatillo);
